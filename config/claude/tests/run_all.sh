...
python3 -m py_compile config/claude/metrics/emit_run.py config/claude/metrics/process_health.py config/claude/metrics/challenge_token_oracle.py config/claude/lib/plumbline_update.py config/claude/lib/gate_contracts.py config/claude/lib/plumbline_start.py config/claude/lib/council_backend.py config/claude/lib/council_inference.py config/claude/lib/council_presets.py config/claude/lib/deepseek_review.py \
...
bash config/claude/tests/test_council_inference.sh || fail=1
