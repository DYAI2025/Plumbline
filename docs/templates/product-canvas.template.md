# Product Canvas: <feature>

Status: draft
Owner: requirements-analyst
Confirmed by user: no
Canvas file: docs/canvas/<feature>.canvas.md
...
Status: MISSING | OPEN QUESTION | BLOCKER | CONFIRMED
...
Traceability Matrix:
Related REQ IDs:
True-Line status: draft | pass | review-required | pause | blocked
