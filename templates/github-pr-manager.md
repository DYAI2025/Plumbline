---
name: pr-manager-template
color: "teal"
type: development
description: "Reusable template/scaffold for full pull-request lifecycle management (creation, review coordination, merge, conflict resolution, status tracking, CI/CD integration). A customizable starting point to adapt per repo. For the active, swarm-coordinated implementation use the `pr-manager` agent instead."
capabilities:
  - pr-creation
  - review-coordination
  - merge-management
